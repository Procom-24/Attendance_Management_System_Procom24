...
SECRET_KEY = 'django-insecure-bkbos6h%ygr2xg=umnjv*r@jcxtww6)js=5e%y(ebucr1$-06('
...
EMAIL_HOST_PASSWORD = 'vcrq auck vsra pmld'  # Replace with the generated app password
